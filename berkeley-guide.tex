...
Einige Versicherungen wollen hierzu einen Nachweis der deutschen Autoversicherung sehen, 
bei anderen kann man den Rabatt auch so bekommen 
(indem man angibt, man habe nie einen Unfall gemacht). 
In Frage kommen z.\,B. GEICO, Progressive (bei der man auch übers Internet eine Policy abschließen kann), 
...
Gute Erfahrungen haben wir mit Strahan Insurance Services (\url{www.strahaninsurance.com}) in Oakland gemacht, 
wo man unkompliziert und sehr fachkundig beraten wird. 
Eine dort vermittelte Versicherung bei Mercury mit höheren Deckungssummen kostete 2012 ca. \$70--80 pro Monat. 
