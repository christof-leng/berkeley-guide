...
\title{Über das Leben in Berkeley}
...
besteht immer die Möglichkeit über das ICSI den Kontakt zu aktuellen Stipendiaten herstellen zu lassen.
...
Um in die USA einreisen zu können, benötigt man als ICSI-Stipendiat ein J1-Visum und mitreisende Angehörige ein J2-Visum. Die Beantragung des Visums und der dafür notwendigen Unterlagen dauert seine Zeit. Obwohl es unwahrscheinlich ist, ist das Visum auch eines der letzten Dinge dich wirklich noch "schief" gehen können und eine Einreise verhindern würden. Daher sollte dies gleich nach Erhalt der DAAD-Unterlagen angestoßen werden. Was braucht man alles, um ein Visum zu bekommen?
...
\begin{itemize}
  ...
  \item Einen deutschen Pass; wenn nicht vorhanden muss dieser beantragt werden und bei der Beantragung sollte man das Ablaufdatum erfragen, da dies fürs Visum benötigt wird. Ein deutscher Reisepass muss bis Ende des Visums gültig sein. Kinder (auch Babys) benötigen einen Kinderreisepass, ein Eintrag im Pass der Eltern oder der alte (grüne) Kinderausweis genügt nicht.
	...
	\item Einen Interviewtermin bei der Botschaft, den man vereinbart, wenn man das DS-2019 zugeschickt bekommen hat. Die Visa-Unterlagen gemäß dem aktuellen Antragsverfahren - da das Antragsverfahren sich dauernd ändert, muss man die aktuell notwendigen Unterlagen für Visa auf der Website der deutschen US-Botschaft (\url{http://germany.usembassy.gov/}) einsehen. Hier entstehen dann auch noch mal Kosten (siehe unten).
...
\begin{enumerate}
	\item \textbf{Das DS-2019:} Das DS-2019 bescheinigt einem vom Gastinstitut (dies ist offiziell die UCB), dass man als Stipendiat dort angenommen ist und dadurch für ein J-1 Visum infrage kommt. Während des Aufenthalts in der USA kommt es der Aufenthalts- und Arbeitsgenehmigung gleich. Zur Beantragung bekommt man auf Anfrage einen Fragebogen vom ICSI zugemailt, den man nur ausgefüllt zurückschicken muss (das ICSI übernimmt die Kommunikation mit dem International Office). Benötigt wird hier das Ablaufdatum des Passes. Wenn ein neuer Pass für den ICSI-Aufenthalt beantragt wird, kann das Ablaufdatum direkt bei der Beantragung erfragt werden. Einige Wochen später bekommt man das DS-2019 vom International Office der UC Berkeley ausgestellt und per Kurier zugestellt.
	...
	\item \textbf{Interview in einer US-Botschaft:} Um ein Visum zu bekommen, ist ein kurzes Interview in einer US-Botschaft notwendig. In Deutschland befinden sich diese in Frankfurt, Berlin und München. Der Termin für ein solches Interview kann telefonisch oder online (beides gebührenpflichtig) vereinbart werden. Vor Semesterbeginn in den USA (August, September) sind Termine oft knapp, weil die Botschaften dann viele Studentenvisa bearbeiten. Bei der Wahl der US-Botschaft sollte man darum nicht nur nach örtlicher Nähe, sondern vor allem nach der stark differierenden Wartezeit für Interviewtermine vorgehen. Vorteil des derzeitigen Interview-Verfahrens ist, dass die Bearbeitung in der Regel schnell geht und man den Pass mit dem Visum etwa drei Tage bis eine Woche nach dem Interview im Briefkasten hat (in dieser Zeit hat man keinen Pass!). Das Visum sollte man unbedingt auf Korrektheit überprüfen.
	
	Beim Besuch der Botschaft ist zu beachten, dass keinerlei Taschen mitgebracht werden dürfen. Jegliche elektronischen Geräte sind auch untersagt. Am Besten man packt nur die notwendigen Dokumente und ein Buch für die Wartezeit ein und lässt alles andere im Auto oder in der Unterkunft. Es gibt im oder am Konsulat in der Regel keine Abstellmöglichkeiten oder gar Schließfächer. Wenn ein Baby mit zum Interview muss (alle Personen für die ein Visum erteilt wird müssen vor Ort sein, auch sechs Monate alte Babys), sollte man auch hier leicht packen. Ein Stipendiat hatte hier Glück und durfte die ganze Wickeltasche mit ins Konsulat nehmen, nachdem der Wachmann auf regelmäßige Windelunfälle verwiesen wurde. Andere wurden aber auch schon abgewiesen und durften nur eine einzelne Windel mitbringen. Da auch diese Regelungen sich regelmäßig verändern sollte man sich selbst vorher auf der Botschaftsseite informieren.
...
Einreise auf jeden Fall im Handgepäck sein.
	...
	\item \textbf{Gebühren:} Bei der Onlineanmeldung zum Interviewtermin und Zusammenstellung der Visumsunterlagen muss eine Gebühr entrichtet werden. Dazu kommt eine Visumsantragsgebühr (120,- EUR pro Person, auch für Kinder), die über die Kanzlei Roskos \& Meier bezahlt wird. Roskos \& Meier senden die Zahlungsbestätigung nach Gelderhalt an den Antragsteller. Das ganze war 2014 komplett online mit Kreditkarte oder Überweisung möglich.
...
Daher bietet es sich an, die Zeit vor Stipendienantritt schon für eine kleine Rundreise zu nutzen (siehe Reisetipps hinten). Das J-Visum erlaubt die Einreise 30 Tage vor Programmbeginn (das Datum auf dem DS-2019). Der nächstgrößere Flughafen von Berkeley aus ist San Francisco Airport (SFO). Alternativ kann man auch nach Oakland (OAK) fliegen, allerdings gibt es nach dort keine Direktflüge von Deutschland aus. Die preislich günstigste Airline (und damit zusammenhängend auch Reiseroute) wechselt ständig. Daher ist es am einfachsten hier eine Reiseplattform zu nutzen. Mit \url{http://www.swoodoo.de} oder \url{http://flights.google.com} haben wir gute Erfahrungen gemacht (für inner-amerikanische Flüge gibt es noch spezielle Plattformen wie  \url{http://www.kayak.com}). Preise sind saisonabhängig, liegen aber für Hin- und Rückflug im Bereich zwischen 700 und 1200 Euro. Wer nur einen Hinflug buchen will, noch kein Rückflugdatum hat, oder länger als 12 Monate bleiben will, kann auch mit Condor oder Norwegian fliegen. Diese Airlines bieten momentan (2015) als einzige bezahlbare one-way Flüge an. Im Sommerflugplan (zwischen Mitte April und Ende September)  fliegt Condor von Frankfurt nach Seattle mit Anschluss nach SFO. Norwegian fliegt ganzjährig für sehr günstige Preise von Stockholm nach Oakland. Sinnvoller ist es aber oft den Rückflug nachträglich gegen Gebühr umzubuchen, wenn man innerhalb von 12 Monaten zurück fliegt. Eine Umbuchung für einen Rückflug dessen Hinflug mehr als 12 Monate zurück liegt ist nicht möglich. Zum Beispiel kostet diese Umbuchung bei British Airways \$150. Alternativ kann auch ein round-trip gebucht, der Rückflug aber verfallen lassen werden.

Bei der Auswahl des Tickets lohnt es sich darauf zu achten, wie viel Gepäck man mitnehmen darf. Dieses ist seit kurzem bei nahezu allen Airlines auf ein Gepäckstück zu 23 kg je Person beschränkt, ein weiteres Gepäckstück kann für ca. 50-100 EUR hinzugekauft werden. Bei manchen Fluggesellschaften ist die Mitnahme eines Sportgerätes (auch Fahrrad) kostenlos möglich. Teilweise lohnt sich auch die Buchung von Premium Economy Plätzen, die dann zwei Gepäckstücke und mehr Sitzfreiheit erlauben.

Insbesondere wenn man mit Kindern reist, sollte man bei der Auswahl der Airline kritischer sein und auf den Service achten. Abzuraten ist hier insbesondere von American Airlines, da es hier z.\,B. für Kleinkinder unter 2 Jahren ohne eigenen Sitzplatz nichts zu essen gibt und das Kinderbett aus einer Pappschachtel besteht. Auch für Babys unter 2 Jahren kann ein Sitzplatz gebucht werden, was mehr Platz und Gepäck erlaubt. Die Kosten für die Reisekosten des Kindes werden auch vom DAAD getragen. 
Für Kinder mit eigenem Sitzplatz kann man in der Regel einen Kindersitz mit in die Kabine nehmen.
Welche Kindersitze dafür geeignet sind, sollte man bei der Airline erfragen. Meistens muss der Sitz explizit für die Verwendung im Flugzeug zugelassen sein (Aufschrift ``for use in aircraft'').
...
Das Mietpreisniveau in Berkeley und der gesamten Bay Area ist deutlich höher als in deutschen
Universitätsstädten. Nahe beim ICSI und damit relativ zentral muss man
damit rechnen, dass man für ein WG-Zimmer um \$1100 zahlt und für eine
kleine Wohnung ab \$1600 aufwärts -- Blick auf die Bay oder Golden
...
typischerweise \$1800-\$2200.
Ein 2BR-Apartment liegt zwischen \$2000 und \$2500,
je nach Lage, Größe, Ausstattung und Zustand.
Ein Studio, d.h. eine Wohnung ohne separates Schlafzimmer,
liegt bei ca. \$1700. Möbelierte Wohnungen kosten ca. \$ 200 mehr pro Monat.


Das ICSI hilft gerne und kompetent bei der
Vermittlung. Leah Hitchcock hilft bei der Beurteilung von Craigslist anzeigen und führt Besichtigungen für die Stipendiaten durch, 
was die Suche von Deutschland aus erheblich vereinfacht. Des weiteren bekommt man über das ICSI den Zugang zum Wohnungsmarkt der 
UC Berkeley, wo manchmal noch zusätzliche Angebote zu finden sind. Die Preise sind hier aber oft eher teurer als bei Craigslist.
...
die BART. Pendeln mit dem Fahrrad aus El Cerrito dauert etwa 20-30
Minuten pro Strecke, aus Albany etwa 15-20 Minuten.

Neben dem UCB-Wohungsportal kann man sich auch selbst nach einer
...
im Portal angeboten werden. Dadurch kann man Geld sparen, wenn man sich
die Grundausstattung an Möbeln selbst bei Ikea oder über Craigslist
zusammenstellt. Möbel und Hausrat sind in etwa gleich teuer wie in
Deutschland. Gebrauchte Dinge werden aber oft noch zu hohen Preisen als aus Deutschland gewohnt und durch deren Zustand gerechtfertigt weiter verkauft. 
Mietverträge für Wohnraum werden sowohl auf Monatsbasis
...
um eine Mietreduzierung auszuhandeln. Einen Mietvertrag auf Monatsbasis hat den Vorteil, dass man jeweils zum Monatsende umziehen kann. 
Ein großer Vorteil von Jahresverträgen ist jedoch, dass im Vertragszeitraum die Miete nicht steigen kann. In der aktuellen Marktsituation hört 
man immer wieder, dass von einem Monat zum nächsten die Miete um \$ 100-200 erhöht wird. 
Zieht man mit einem Jahresvertrag vorzeitig aus, ist man prinzipiell verpflichtet einen Nachmieter zu finden 
oder die Restmiete bis zum Ablauf des Vertragszeitraums zu bezahlen. Das kalifornische Gesetz ist hier aber sehr mieterfreundlich, 
da es reicht einen ``vernünftigen'', einzugswilligen Nachmieter zu präsentieren. Lehnt der Vermieter diesen ab, 
muss man in der Regel nicht weiter Miete zahlen. In der aktuellen Marktsituation ist es sehr wahrscheinlich innerhalb kürzester Zeit einen Nachmieter zu finden.
...
schlecht wärmeisoliert, was insbesondere in den Wintermonaten zu einem unangenehmen Raumklima führen kann.

Craigslist (\url{http://sfbay.craigslist.org}) ist prinzipiell die zentrale Anlaufstelle für die Wohnungssuche im
...
besichtigen -- oder vom ICSI besichtigen lassen.)
Mit \url{http://www.padmapper.com} kann man sich die Wohnungsangebote
übersichtlich auf einer Google Map anzeigen lassen.

Es kann sich lohnen beim ICSI nach abreisenden internationalen Besuchern zu fragen und deren Wohnung zu übernehmen. 
Neben Wohnung lassen die abreisenden Stipendiaten
...
Zwischenmieten für Wohnungen und WG-Zimmer vermittelt. Aufgrund des schnelllebigen Wohnungsmarkts,
kann man in der Regel innerhalb von wenigen Tagen oder Wochen einziehen.

\subsection{Utilities}

Hat man sich eine Wohnung gesichert bei der man selbst für die Anmeldung von Strom, Gas, Internet und TV zuständig ist, kann man dies sehr schnell und einfach erledigen. Da man nach der Einreise in der Regel noch keine US Sozialversicherungsnummer und Kreditwürdigkeit hat, funktioniert die Anmeldung per Internet meist nicht. Die relevanten Firmen haben aber Shops in Berkeley in denen die Anmeldung erfolgen kann. Man zeigt dann seinen Reisepass vor und muss einen Deposit hinterlegen (\$50 - \$100) und ist nach 10 Minuten fertig. Strom und Gas meldet man bei PG\&E (pge.com) an. Der Shop befindet sich im selben Block wie das ICSI (PG\&E Customer Service Office, 1900 Addison St, Berkeley 94704). 

Beim Thema Internet und TV ist die Auswahl der möglichen Anbieter nicht sehr groß. Man hat die Wahl zwischen AT\&T DSL und Kabelfernsehen oder Comcast/xfinitiy Kabel-Internet und -fernsehen. Die meisten Amerikaner wählen Comcast, da es den schnellsten und zuverlässigsten Anschluss bietet. Beim TV bietet insbesondere das neue X1 Entertainment System von comcast amerikanischen Fernsehgenuss vom Feinsten. Der Internetanschluss kostet ca. \$30-50 pro Monat je nach Geschwindigkeit und zusammen mit einem sehr umfangreichen X1 HD Kabelpaket kommt man auf ca \$110 monatlich. 

Der Comcast Shop befindet sich zwei Blocks vom ICSI entfernt (1936 University Ave \#103, Berkeley, CA 94704) und man bekommt dort alle Geräte und Kabel zum Selbstanschluss mitgegeben und ist in der Regel direkt online, insofern der Vormieter den selben Anbieter hatte. Entgegen der vielen negativen Reviews bei Yelp etc. hatte zumindest ein Stipendiat ganz hervorragende Erfahrungen mit dem Kundendienst dort. Es empfiehlt sich außerdem anstatt das Kabelmodem von Comcast zu mieten (\$10 pro Monat) ein eigenes für ca \$70 bei Amazon oder Bestbuy zu kaufen. Nach 7 Monaten lohnt es sich schon. Die Geschwindigkeit bei allen Anbietern schwankt je nach Anschluss und Tageszeit. Die meisten Anbieter haben günstige Angebote für die ersten 6 oder 12 Monate, so dass es sich lohnen kann nach Ablauf der ``Schonfrist'' den Anbieter zu wechseln.

Eine weitere Alternative für den Internetzugang zuhause, z.B. wenn man kein TV Anschluss haben möchte, ist die Nutzung eines 4G/LTE Hotspots (z.B. von T-Mobile). Die Angebote variieren hier stark und sollten daher selbst verglichen werden.
...
\url{http://internationaloffice.berkeley.edu/j\_insurance}). 
 ...
 mit der man gut fährt (ca. 137 Euro pro Monat und Person). 
Alternativen sind die Mawista (Würzburger), Victoria, DKV, UKV, oder ACE, die deutlich günstiger als die Gruppenauslandskrankenversicherung des DAAD sind (bei der Mawista gelten Postdocs noch als Studenten). Die Bedingungen sind bei allen ähnlich, aber in der Regel weniger komfortabel als die DAAD Versicherung. Alle Versicherungen schließen Kosten aus bestimmten Anlässen (z.\,B. vor Versicherungsantritt, Vorerkrankungen, Vorsorgeuntersuchungen) aus. Einige deutsche Anbieter (u.\,a. die DAAD Versicherung und die genannte Mawista) kooperieren mit US-amerikanischen Versicherungen, so dass man bei einer Behandlung nicht in Vorkasse treten muss, sondern einfach die Versichertenkarte vorzeigt. Der behandelnde Arzt kann dann über das lokale System abrechnen, und man selbst muss die Rechnungen nicht mehr bei der deutschen Versicherung einreichen. Die DAAD-Versicherung kooperiert mit der Firma Global Medical Management (GMM) in Florida. Man kann von dieser Firma einen Versicherungsausweis erhalten (Online zum selbst ausdrucken) und der Arzt kann die Behandlungskosten dann direkt mit GMM abrechnen. Auf der Homepage der Continentale/GMM gibt es eine Liste von Ärzten, bei denen man sich behandeln lassen kann ohne Vorkasse zu leisten. Für die meisten Fälle gibt es in Berkeley und umgebung geeignete Ärzte.
Wenn man sich für einen Arzt entscheidet, der nicht auf der GMM-Website gelistet ist, sollte man sich vorher erkundigen, ob der betreffende Arzt trotzdem zu einer Behandlung bereit ist. Man wird aber immer zunächst selbst die Kosten begleichen müssen.
...
Eine Kinderärztin mit recht gutem Ruf ist Karin Schiffman in 2500 Milvia Street, Raum 102 (Tel.: (510) 845-0300). Auch mit Kiwi Pediatrics (http://kiwipediatrics.com/) ist zu empfehlen. Verschreibungspflichtige Marken-Medikamente sind in den USA sehr teuer. Man kann oft deutlich sparen, wenn man Generika, z.\,B. aus dem Internet bestellt.
...
\item abreisende Postdocs: ehemalige ICSI-Stipendiaten oder Angebote auf der Postdoc-Net Mailingliste sowie diverse Facebook Gruppen.
...
Beispiel bei Walgreens und an Automaten in den MUNI Stationen in San Francisco. Sie kann für alle öffentlichen Verkehrsmittel
...
Eine kurze, einfache Fahrt mit der BART ist (bei bis zu 2-3 Stationen) ist mit \$1,75 nicht nur preiswerter, sondern auch wesentlicher schneller als der Bus. Weitere Pluspunkte der BART sind ein dichter (7 1/2 Minuten werktags, 20 Minuten abends/am Wochenende) und längerer (bis 24 Uhr) Fahrtakt.
Die Fahrt von Berkeley nach San Francisco kostet momentan ca. \$5. 
...
In Berkeley und San Francisco kann man sich eigentlich sehr gut mit Rad, Bus und BART fortbewegen. Sollte man aber größere Einkäufe haben oder nicht im Downtown Bereich wohnen, empfiehlt sich ein Auto sehr.
Man sollte auch nicht vergessen, dass man in Kalifornien, und damit auf einem besonders schönen Fleckchen Erde gelandet ist, das man auch ruhig erkunden darf. 
...
Gerade über die Postdoc-Liste kommen häufig Angebote für Autos, die ein gutes Stück unter dem kbb.com-Preis liegen. Es sollte gesagt werden, dass gerade alte, gebrauchte Autos deutlich teurer sein können als in Deutschland. Ein Toyota Sienna Minivan aus dem Jahr 2001 mit ca 150k Meilen konnte 2015 nicht unter \$3,700 gekauft werden. Auch kleinere Autos (``sedans'') in diesem Altersbereich kosten oft nicht wensentlich weniger als \$2,700.

In Berkeley gibt es u.\,a. den Zwischenhändler Buggybank, bei der Privatpersonen gegen Gebühr ihre Autos ausstellen können; man hat hier keine Garantie, dass die Wagen in Ordnung sind, aber man kann zu Geschäftszeiten Probefahrten machen und sich alles vorher im Internet anschauen (\url{http://www.buggybank.com}). Die Überprüfung durch einen Mechaniker ist beim Kauf von privat immer dringend zu empfehlen und auch unkompliziert über Buggybank zu organisieren (\$80). Die meisten Werkstättenb ieten diesen Service an. Der Bericht des Mechanikers kann hier auch sinnvoll bei den Preisverhandlungen eingesetzt werden. Durch die schlechten Straßenoberflächen ist zu erwarten das gerade die Aufhängung in schlechtem Zustand ist. Achten sollte man auch auf regelmäßige Inspektionen (Stichwort ``belts'' -- Zahn- und Keilriemen) und Öl- sowie Getriebeflüssigkeitswechsel.
...
Wenn man in Deutschland schon einige Jahre unfallfrei fährt, 
kann man bei einigen Versicherungen einen Good Driver's Rebate bekommen, 
was die Kosten erheblich senkt. 
Einige Versicherungen wollen hierzu einen Nachweis der deutschen Autoversicherung oder des Kraftfahrtbundesamtes über das nicht-Vorahndensein von Punkten sehen, 
bei anderen kann man den Rabatt auch so bekommen 
(indem man angibt, man habe nie einen Unfall gemacht). 
In Frage kommen z.\,B. GEICO, Progressive (bei denen man auch übers Internet eine Policy abschließen kann), 
Mercury (die zudem einen Rabatt für Ingenieure und Wissenschaftler anbieten), 
das ADAC-Äquivalent AAA, 
oder auch Agenturen, die Policies verschiedener Anbieter verkaufen und dort etwas Günstiges anbieten können. 
Gute Erfahrungen haben wir mit GEICO und Strahan Insurance Services (\url{www.strahaninsurance.com}) in Oakland gemacht, 
wo man unkompliziert und sehr fachkundig beraten wird. 
Eine dort vermittelte Versicherung bei Mercury mit höheren Deckungssummen kostete 2012 ca. \$70--80 pro Monat. Bei Geico kostet besagter Toyota Minivan \$280 im halben Jahr.
...
Die Prüfung ist nicht teuer (\$37) und auch nicht schwer, wenn man sich passend vorbereitet. Alle nötigen Informationen und das California Driver's Handbook gibt dazu im Internet (\url{http://dmv.ca.gov}). Der Test besteht aus 36 Multiple-Choice-Fragen, die auf dem California Driver Handbook basieren, jedoch nicht den ``Sample Tests'' entsprechen. Kopien von alten echten Tests zirkulieren am ICSI.  Mit der bestandenen schriftlichen Prüfung erhält man einen vorläufigen Führerschein, mit dem man dann die Praxisprüfung beantragen kann. Wenn man einen deutschen Führerschein besitzt, kann man sich für die Prüfung ein Auto ausleihen. Wichtig ist dabei, dass man das Komplett-Versicherungspaket mitbucht, da dies beim DMV vor der Prüfung kontrolliert wird. Seit Mai 2015 ist es auch so, dass man als Deutscher mit deutschem Führerschein nicht mehr alleine zur Praxisprüfung erscheinen darf. Beim Check-In muss eine weitere Person mit kalifornischem Führerschein anwesend sein. Dies hält einen jedoch nicht davon ab alleine mit dem eigenen Auto zum DMV zu fahren und sich dort mit der anderen Person zu treffen. Beim Test selbst ist keine weitere Person erlaubt. Alternativ kann man den vorläufigen Führerschein auch regelmäßig kostenlos verlängern und muss so den (kostenlosen) Praxistest nicht mehr machen. Allerdings bekommt man dann auch keine California Driver's License, die als ID gerne gesehen wird.

Der Praxistest selbst ist sehr einfach. Man sollte sich vorher von Kollegen schildern lassen wie der Test in etwa abläuft, aber in der Regel fährt man für ca. 10 Minuten durch die Anwohnerstraßen hinter dem DMV und muss hauptsächlich die Geschwindigkeitslimits und Stop-Schilder beachten können. 
...
günstigeres organic Angebot und günstigere EU-Produkte bekannt. Berkeley Bowl ist ein vollsortiment Supermarkt, der eine sehr große (Bio-) Gemüseabteilung bietet und ist der Favorit vieler Berkeley-aner. 
...
Märkten bekommt man Gemüse und Obst aus der
Umgebung. Es gibt ein großes Angebot an Bioprodukten. Gegenüber vom
Monterey Market gibt es das nette Café ``Esspresso Roma''. Im Ranch 99 Market zwischen Albany und Richmond findet man eine ähnlich große Auswahl, jedoch mit stärkerem Fokus auf asiatische Lebensmittel und Fisch. Für frischen Fisch ist außerdem der Tokyo Fish Market, Ecke Gilman und San Pablo Avenue zu empfehlen.
...
noch viele andere Brotsorten. Insbesondere am Wochenende ist hier aber eine ansehnliche Schlange vor der Tür vorzufinden. Also keine Angst, auf
...
(\url{http://www.premiumoutlets.com}). Direkt in Berkeley lohnt sich allerdings ein Besuch in dem unfassbar günstigen Northface-Outlet (5th und Gilman). 
Eine recht große Einkaufsstraße findet man in der Bay Street in Emeryville, auf der halben Strecke nach
San Francisco, wo sich auch ein IKEA befindet. Eine ``richtige'' amerikanische Mall findet sich in Downtown San Francisco (Powell Street) und Richtung Livermore (Stoneridge Mall). Noch weiter Richtung Osten finden sich die San Francisco Premium Outlets mit einer guten Auswahl an Shops.
...
Die Deutsche Bank hat ein Abkommen mit der Bank of America, so dass man als DB-Kunde an den BoA-Automaten gebührenfrei abheben kann. Kontoführungsgebühren entfallen, wenn man einen gewissen Mindestumsatz oder Anzahl an Transaktionen pro Monat hat oder aber ein Onlinekonto eröffnet (man kann sich dann allerdings nicht mehr direkt in der Bank beraten lassen).

Man sollte sich in jedem Fall ein amerikanisches Konto einrichten. Eine der ersten Aktivitäten in Berkeley sollte daher das Eröffnen eines Checking Accounts sein. Gute Erfahrungen wurden mit der Bank of America, der Wells Fargo-Bank, der Citi-Bank und der Mechanics-Bank gemacht. Alle vier haben Niederlassungen in der Nähe des ICSI und bieten kostenlose Online-Konten. Während bei der Bank of America nahezu alles online und am ATM erledigt werden kann, bietet Wells Fargo zudem noch bei einem kostenlosen Konto (Personal Checking Account -- die Gebühren entfallen bei 10 Umsätzen im Monat) einen hervorragenden persönlichen Service in den Filialen.

Zur Kontoeröffnung sollte man den Reisepass mitnehmen, manchmal wird auch ein Adressnachweis verlangt. Wenn man seine Miete per Scheck bezahlen muss (das ist hier der gängige Weg) sollte man darauf achten, welche Kosten dies bei der entsprechenden Bank verursacht. Bei Chase, Mechanics, und Wells Fargo bekommt man zur Kontoeröffnung einen Stapel Schecks geschenkt, bei der Bank of America muss man dafür zahlen. Bei Chase, Wells Fargo und der Bank of America können Schecks außerdem bequem und kostenfrei online in Auftrag gegeben werden, auch per Dauerauftrag. Die Bank stellt den Scheck dann aus und per Post an die angegebene Adresse zu.
...
Im Jahr 2015 haben einige Stipendiaten sehr gute Erfahrungen mit Wells Fargo gemacht. Diese Bank verbindet die Vorteile der Bank of America mit dem Service der Mechanics Bank.

\paragraph{Geldtransfer aus Deutschland}

Die häufig günstigste Variante, Geld vom deutschen Konto auf das amerikanische Konto zu transferieren, ist, das Geld am ATM mit der Kreditkarte oder EC-Karte abzuheben und direkt am ATM auf das eigene Konto einzuzahlen (maximal \$800 je Transaktion sowie ein Limit von 1.000 Euro pro Tag und 10.000 Euro pro Monat bei der DKB Visa Karte). Für den täglichen Bedarf ist dies vollkommen ausreichend. Für größere Ausgaben wie einen Autokauf sollte man hier aber rechtzeitig planen.

Ansonsten kann man Auslandsüberweisungen von Deutschland nach USA verwenden, muss aber dafür saftige Gebühren zahlen (ca. \$15 pro eingehender Überweisung nehmen die amerikanischen Banken, von der deutschen Bank kommen in der Regel noch 2--15 Euro dazu). Bei größeren Beträge kann dies allerdings die günstigste Alternative sein. Seit einiger Zeit kann auhc der Service TransferWise genutzt werden. Die Gebühren sind geringer als bei der Bank direkt und die Wechselkurse meist besser.
...
Prepaid-Verträge kosten bei den meisten Anbietern um 10\,ct pro Minute. Mitlerweile sind allerdings Pakettarife eher in Mode. Hier zahlt man ca. \$40-\$50 im Monat für 1-3GB Daten sowie Flatrates für talk\&text. Ein günstiges Handy gibt es meist ab \$20 oder gar im Angebot mit einem Guthaben umsonst. Minutenguthaben sind meist ein oder zwei Monate gültig (bei T-Mobile im 1000 Minuten-Paket sogar ein Jahr). Net10 erlaubt für 5\,ct Aufpreis pro Minute dafür noch Anrufe ins deutsche Festnetz.
...
welche für den Internet- und Bürozugang zwingend notwendig ist. Die Beantragung dieser ID ist jedoch eine der großen Hürden als ICSI PostDoc und sollte daher so früh wie möglich in Angriff genommen werden. Der gesamte Prozess kann sich ohne aktives reguläres Nachfragen eine halbe Ewigkeit hinziehen (bis zu 6 Monate). Startpunkt des Prozesses ist der betreuende Gruppenleiter am ICSI, der die Anerkennung als sogenannter Volunteer (wichtiges Schlüsselwort!) beantragen kann. Als Volunteer erhält man zwar keinen PostDoc Status bei der UCB, aber man kann wenigstens die Infrastruktur auf dem Campus nutzen (aber keine Bücher ausleihen). In der Regel wird der Volunteer Status nur für einen Monat anerkannt, es wurden aber bereits mehrmals Ausnahmen gemacht und der Status für den gesamten Aufenthalt erteilt. Mit dem erfolgreichen Antrag bekommt man dann eine CalID (eine Karte mit Foto) sowie Zugangskennungen für WiFi und Email.
...
%Gleich am Anfang hat der Sohn einen sehr netten Klassenkameraden als Buddy bekommen, 
% der ihm Dinge gezeigt hat und ihn in den Pausen mit zum Spielen genommen hat.
...
Ehemalige DAAD-Stipendiaten mit Familie sind Klaus Wehrle, dessen Bericht sich zu lesen lohnt, sowie Manfred Eppe und Marian Harbach.
...
Zuletzt gibt es noch zwei Kletter- bzw. Boulderhallen, die gleichzeitig auch Fitnessstudio sind. An der Ashby Ave sind die Berkeley Iron Works und in El Cerrito das Bridges Rock Gym. Beide bieten regelmäßige Aktionen bei denen Aufnahmegebühren erlassen werden.
...
%Und vielleicht werdet ja auch ihr vom Baseball-Fieber erfasst und merkt plötzlich wie ihr trotz eures Heidentums innbrünstig betet dass Tim Lincecum noch einen Strike pitcht oder Cody Ross einen Homerun schlägt... 
...
In Berkeley selbst sind der Jachthafen (Marina) und der angrenzende Cesar Chavez Park gute Ausflugsziele, von wo man eine wundervolle Aussicht über die Bay und auf die Golden Gate Bridge hat. Besonders im Sommer ist der Park ein attraktiver Ort für ein Barbecue mit Freunden. Schön sind natürlich der weitläufige Campus und der nahegelegene Tilden Park. Der Campus der UC Berkeley ist weitläufig und grün, und mit historischen Gebäuden vom Anfang des 20. Jahrhunderts bestückt. Hier findet man auch das Freedom Cafe, in dem in den 60ern die Protestform des sit-ins (als Protest gegen den Vietnamkrieg) erfunden und perfektioniert wurde.
...
An diesem Bericht haben mitgeschrieben: Michael Elberfeld, Daniel Göhring, Matthias Kirchner, Christof Leng, Gerard de Melo, Korbinian Riedhammer, Erik Rodner, Daniel Warneke und Marian Harbach. 
